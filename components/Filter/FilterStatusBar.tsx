...
export default function FilterStatusBar({
  ...
  return (
    <div
      ...
      aria-live="polite"
      aria-atomic="true"
      className="mt-4 md:mt-6 ml-3 mr-3 flex items-center justify-between gap-4 px-4 py-3 bg-gradient-to-r from-pink-50 to-blue-50 dark:from-pink-900/20 dark:to-blue-900/20 border border-gray-200 dark:border-gray-700 border-l-4 border-pink-500 dark:border-pink-400 rounded-r-lg shadow-sm transition-colors duration-200"
    >
      ...
      <button
        onClick={onClear}
        className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium transition-colors text-gray-700 dark:text-gray-300 leading-4"
