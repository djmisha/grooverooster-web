...
const EventPills = ({ event, centered = false }: EventPillsProps) => {
  ...
  return (
    <div className={containerClasses}>
      {genreName && (
        <span className="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs font-medium rounded-full transition-colors duration-200">
          {genreName}
        </span>
      )}
      {sourceValue && (
